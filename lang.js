const translations = {
  en: {
    ...
    mainDesc:
      "Here you can find some of my small web projects I made to learn more about web development!",
    proj1Link: "Project 1",
  ...
  de: {
    ...
    mainDesc:
      "Hier findest du einige meiner kleinen Webprojekte, die ich gemacht habe, um mehr über Webentwicklung zu lernen!",
    proj1Link: "Projekt 1",
  ...
  ru: {
    ...
    mainDesc:
      "Здесь вы найдете некоторые из моих небольших веб-проектов, которые я сделал, чтобы узнать больше о веб-разработке!",
    proj1Link: "Проект 1",
...
document.getElementById("lang-select").addEventListener("change", function () {
  ...
  document.getElementById("main-desc").textContent =
    translations[lang].mainDesc;

  // Project lists
  document.getElementById("proj1-link").textContent =
    translations[lang].proj1Link;
  document.getElementById("proj1-desc").textContent =
    translations[lang].proj1Desc;
  document.getElementById("proj2-link").textContent =
    translations[lang].proj2Link;
  document.getElementById("proj2-desc").textContent =
    translations[lang].proj2Desc;
  document.getElementById("proj3-link").textContent =
    translations[lang].proj3Link;
  document.getElementById("proj3-desc").textContent =
    translations[lang].proj3Desc;
  document.getElementById("proj4-link").textContent =
    translations[lang].proj4Link;
  document.getElementById("proj4-desc").textContent =
    translations[lang].proj4Desc;
  document.getElementById("proj5-link").textContent =
    translations[lang].proj5Link;
  document.getElementById("proj5-desc").textContent =
    translations[lang].proj5Desc;
  document.getElementById("proj6-link").textContent =
